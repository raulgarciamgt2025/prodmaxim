    ...
    <Col xl={7}>
      <Card>
        ...
        <CardBody>
          <Row>
            <Col xl={7}>
              <div id="world-map-markers-line" style={{ height: '318px' }}>
                <WorldVectorMap height="318px" width="100%" options={worldMapOptions} />
              </div>
            </Col>
            <Col xl={5} dir="ltr">
              <div className="p-3">
                {visitorTrafficsData.map((item, idx) => (
                  <Fragment key={idx}>
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <h5 className="fw-semibold mb-0">{item.count}k</h5>
                      </div>
                    </div>
