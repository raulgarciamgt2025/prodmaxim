    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <Link to="https://getbootstrap.com/docs/5.3/utilities/colors/">color utilities</Link>.
        </>
      }>
      <Row>
        <Col xs={12}>
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <code>static</code>, which can be set with custom styles or using our <Link to="/docs/5.3/utilities/position/">position utilities</Link>.
        </>
      }>
